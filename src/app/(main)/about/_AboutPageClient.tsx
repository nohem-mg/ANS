...
function StorySection({ data, storyData }: { data: any, storyData: typeof STORY_DATA }) {
  return (
    <section
      id="notre-histoire"
      ...
      <div style={{ maxWidth: 1280, margin: '0 auto' }}>
        <FadeIn style={{ marginBottom: '80px', position: 'relative' }}>
          ...
          <div style={{ position: 'relative', zIndex: 1, maxWidth: 640 }}>
            <SectionTag index="01" label={data?.story?.tag ?? 'Histoire'} />
            <h2
              style={{
                fontFamily: FONT.display,
            ...
            >
              {data?.story?.title ?? 'Notre Histoire'}
            </h2>
            <p
              style={{
            ...
            >
              {data?.story?.description ?? "Plus de 40 ans de passion à transformer l'univers du travail autour de moments chaleureux et de services irréprochables."}
            </p>
          </div>
        </FadeIn>
      ...
      >
        ...
        <FadeIn style={{ position: 'relative' }}>
          ...
          <div style={{ position: 'relative', zIndex: 1 }}>
            <SectionTag index="03" label={data?.careers?.tag ?? 'Carrières'} />
            <h2
              style={{
                fontFamily: FONT.display,
            ...
            >
              {data?.careers?.title ?? 'Nous Rejoindre'}
            </h2>
            <p
              style={{
                fontFamily: FONT.body,
