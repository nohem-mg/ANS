...
const Timeline = ({ milestones }: { milestones: { year: string; title: string; desc: string }[] }) => {
...
const IMG_KEYS = ['/pause-evasion.png', '/convivialite-equipe.png', '/qualite-vie-travail.png', '/solution-simplicite.png'];

const VisionSection = ({ cards, label, description }: { cards: { title: string; desc: string }[]; label: string; description: string }) => {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10 w-full mb-12 lg:mb-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-start">
          ...
          >
            ...
            >
              <span className="text-sienna-racing">{cards[0]?.title ?? ''}</span>
            </h2>
          </motion.div>
              ...
              >
                <div className="flip-card-inner w-full h-full">
                  ...
                  <div className="flip-card-back overflow-hidden shadow-lg bg-[#688125]">
                    <img
                      src={IMG_KEYS[index] ?? `/carte${index + 1}.png`}
                      alt={point.title}
...
export default function HomeClient({ data }: { data: HomepageData }) {
  const { hero, vision, services, rse, histoire, temoignages, faq, cta_band, footer_cta } = data;
  ...
  return (
    <>
      ...
      >
        ...
        <VisionSection
          cards={[...(vision?.cards ?? [])]}  
          label={vision?.section_label ?? 'Notre Vision'}
        ...
        <section id="services" className="pt-8 pb-8 md:py-20 relative">
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-6 md:mb-12">
              <div>
                <span className="text-golden-extraction text-[10px] tracking-[0.22em] uppercase mb-5 block" style={{ fontFamily: 'var(--font-ibm-plex-mono)' }}>{services?.section_label ?? 'Notre Savoir-Faire'}</span>
                <h2 className="text-deep-roast leading-tight" style={{ fontFamily: 'var(--font-sora)', fontSize: 'clamp(1.75rem, 3.5vw, 3rem)', fontWeight: 600, letterSpacing: '-0.02em' }}>
                  {services?.title ?? "L'Excellence de la Pause Café."}
                </h2>
              </div>
            ...
            <div className="border-t border-deep-roast/10">
              {(services?.items ?? []).map((item, i) => (
                <ServiceRow
                  ...
                  title={item.title}
                  desc={item.desc}
                  icon={i === 0 ? <CoffeeCornerIcon /> : i === 1 ? <MaintenanceIcon /> : <PartnershipIcon />}
                />
              ))}
            </div>
            ...
            >
              ...
              <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6 px-4 md:px-0">
                <div>
                  ...
                  >
                    {cta_band?.title ?? "Un projet d'espace-pause ?"}
                  </h3>
                  <p
                ...
                <div className="flex flex-col sm:flex-row items-center gap-3 shrink-0 w-full sm:w-auto">
                  <motion.a
                    ...
                    whileTap={{ scale: 0.97 }}
                  >
                    {cta_band?.cta_label ?? 'Demander un devis'} <ArrowRight size={14} />
                  </motion.a>
                  <a
                    href={cta_band?.phone_href ?? 'tel:0327371684'}
        ...
        <section id="adn" className="pt-6 pb-4 md:pt-12 md:pb-24 relative overflow-hidden">
          <div className="max-w-7xl mx-auto px-6 lg:px-10 relative z-10">
            ...
            >
              <div>
                <span className="block text-[10px] font-mono uppercase tracking-[0.22em] text-golden-extraction mb-4">
                  {histoire?.section_label ?? 'Notre Histoire'}
                </span>
                <h2
                  className="text-deep-roast leading-tight"
                  style={{
                ...
                >
                  {histoire?.title ?? '+ de 40 Ans d\'Excellence'}
                </h2>
              </div>
            ...
            <Timeline milestones={[...(histoire?.milestones ?? [])]} />
          </div>
        </section>
            ...
            >
              <div className="flex flex-col lg:flex-row gap-10 lg:gap-16">
                ...
                <div className="lg:w-[40%] shrink-0">
                  <span className="block text-[10px] font-mono uppercase tracking-[0.22em] text-golden-extraction mb-4" style={{ fontFamily: 'var(--font-ibm-plex-mono)' }}>
                    {rse?.section_label ?? 'Notre Engagement'}
                  </span>
                  <h2
                    className="text-deep-roast leading-tight"
                    style={{
                  ...
                  >
                    {rse?.title ?? 'Une démarche durable et responsable'}
                  </h2>
                </div>
        ...
        <section id="contact" className="pt-8 pb-16 md:py-20 relative overflow-hidden bg-[#FAF2E9]">
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center relative z-10">
            <h2 className="text-3xl sm:text-5xl md:text-7xl mb-6 tracking-tight" style={{ fontFamily: 'var(--font-sora)', fontWeight: 600 }}>{footer_cta?.title ?? 'Prêt pour l\'infusion ?'}</h2>
            ...
            <div className="flex items-center justify-center gap-3 sm:gap-4 mb-10">
              <motion.a
                ...
                whileTap={{ scale: 0.97 }}
              >
                {footer_cta?.cta_label ?? 'Nous contacter'} <ArrowRight className="w-4 h-4" />
              </motion.a>
              <motion.a
                href={footer_cta?.phone_href ?? 'tel:0327371684'}
              ...
              >
                ...
                {footer_cta?.phone ?? '03 27 37 16 84'}
              </motion.a>
            </div>
            ...
            >
              {footer_cta?.tagline ?? 'Audit gratuit · Réponse sous 24h · Hauts-de-France'}
            </p>
          </div>
        </section>
